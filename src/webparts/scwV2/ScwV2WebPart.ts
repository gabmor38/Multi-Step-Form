...
import { IScwV2Props } from './components/IScwV2Props';

export interface IScwV2WebPartProps {
  context: WebPartContext
  prefLang: string;
  url: string;
}

export default class ScwV2WebPart extends BaseClientSideWebPart<IScwV2WebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IScwV2Props> = React.createElement(
      ScwV2,
      {
